...
* **S. Li**#, M. V. Petty, N. Safron, A. Wei, S. Natani, D. Zhong, S. Y. Lee, A. A. Wu, P. Bandaru, A. Kummel, I. Radu, G. Pitner, S. Mitra, H.-S. P. Wong, “10-nm-Gate-Length Nanosheet CNFET with Self-Aligned Extension Doping for Ambipolar Leakage Suppression.” IEEE Symposium on VLSI Technology and Circuits (2026).
* J. Kang, K. Jana, N. Safron, D. Zhong, H.-S. P. Wong#, **S. Li**#. "Quantum-Well Oxide Semiconductor Transistors Overcome Mobility–VT Trade-Off." IEEE Transactions on Electron Devices (2026).
* B. Wang, Y. Liu,  J. Liu,  H. Shi, H. Guo, M. Li, Z. Zhang, Y. Guo, **S. Li**, M. Wang and C. Cheng, "Energy Level Engineering of PbS Quantum Dots via Aluminum Surface Modification for High-Performance Infrared Photodetectors". Nano Letters (2025).
...
* S. Choi, A. Raut, T. Wu, S. Dayo, A. Bechdolt, G. Dutta, **S. Li**, DT. Rich, RH. Yang, AC. Yu, M. Nelson, MM. Shulaker, RM. Radway, S. Mitra, T Srimani#. "Foundry Monolithic 3D Unlocks Large Throughput Benefits: 3D Memory with Tucked Sense Amplifiers+ Logic using Heterogeneous Silicon CMOS+ Resistive RAM+ Carbon Nanotube FETs." IEEE International Electron Devices Meeting (2025).
...
======
* Shengman Li. “Process and Material Innovation for High-performance Front/Back-End-of-Line Transistors” ENGE 2026, Jeju, Korea, November 2026. (Invited talk)
* Shengman Li. “Advancing High-Performance FEOL/ BEOL Transistors throughProcess and Materials Innovation” The 26th IEEE International
Conference on Nanotechnology, Nanjing, China, July 2026. (Invited talk)
